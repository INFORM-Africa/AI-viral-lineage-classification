...
data = pd.read_parquet(f'../../data/features/{args.File}.parquet', engine='pyarrow')  # You can use 'fastparquet' as the engine
...
correlation_matrix.to_parquet(f'../../data/features/{args.File}_dist.parquet', engine='pyarrow')
