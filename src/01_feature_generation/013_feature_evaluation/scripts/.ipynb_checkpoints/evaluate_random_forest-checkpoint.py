...
def predict_and_save(rf, X_test, y_test_orig, label_encoder, file_name, prediction_set, dataset):
    """
    ...
    predictions_file_path = f'predictions/{dataset}/random_forest_{prediction_set}.csv'
...
def main():
    ...
    predict_and_save(rf, X_train, y_train_orig, label_encoder, file_name, "Training", args.Data)
    predict_and_save(rf, X_val, y_val_orig, label_encoder, file_name, "Validation", args.Data)
    predict_and_save(rf, X_test, y_test_orig, label_encoder, file_name, "Testing", args.Data)
